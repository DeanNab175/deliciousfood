 ...
 */
function watchTask() {
  watch( [path.fonts.src, path.images.src], {usePolling : true}, series( fontsTask, imageminTask, reload ) );
  ...
  watch( path.html, {usePolling : true}, series( reload ) );
}
...
exports.default = series(
  ...
  parallel(cacheBustTask, browserSyncTask, watchTask)
);